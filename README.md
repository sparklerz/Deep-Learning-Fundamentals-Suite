...
A **multipage Streamlit app** that showcases core Deep Learning tasks (tabular, NLP, time-series, vision).
...
- **📈 Time-Series Forecasting (LSTM | PyTorch)** — `ash001/timeseries-forecast-lstm`
- **🐱🐶 Cats vs Dogs Classification (Transfer Learning CNN | PyTorch)** — `ash001/cats-dogs-transferlearning-cnn`
